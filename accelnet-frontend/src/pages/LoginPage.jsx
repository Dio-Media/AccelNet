...
import { useAuthStore } from "../store/useAuthStore"; // adjust path if your store folder differs
...
const LoginPage = () => {
  ...
  const handleLogin = async (e) => {
    ...
    if (result?.success) {
      navigate("/"); // redirect to home (or /dashboard if you prefer)
    }
  };
        ...
        <div className='w-full max-w-md p-8 space-y-6 bg-blue-900 rounded-lg shadow-md '>
          ...
          <form className='space-y-4' onSubmit={handleLogin}>
            ...
            <button
              ...
              className='w-full py-2 bg-blue-600 text-white font-semibold rounded-md hover:bg-blue-700 disabled:opacity-60 disabled:cursor-not-allowed'
            >
